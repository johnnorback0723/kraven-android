...
public class CountriesFetcher {
        ...
        try {
            ...
            for (int i = 0; i < countries.length(); i++) {
                try {
                    ...
                    mCountries.add(new Countrys(country.getString("name"), country.getString("iso2"), country.getInt("dialCode")));
    ...
    public static class CountryList extends ArrayList<Countrys> {
        /**
