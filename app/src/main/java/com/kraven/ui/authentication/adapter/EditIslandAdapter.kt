...
class EditIslandAdapter(var islandId: String, val onRecycleItemClick: OnRecycleItemClick<Island>) : AdvanceRecycleViewAdapter<EditIslandAdapter.ViewHolder, Island>() {
