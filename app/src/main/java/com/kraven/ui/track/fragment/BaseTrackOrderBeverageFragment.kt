...
abstract class BaseTrackOrderBeverageFragment : BaseFragment() {
    ...
    fun getPickUpDate(orderDetails: BeverageHistoryDetails) {
    ...
    fun getDeliveryData(orderDetails: BeverageHistoryDetails) {
        textViewOrderIdLabel.text = getString(R.string.order_id, orderDetails.id.toString())
    ...
    private fun getPendingData(orderDetails: BeverageHistoryDetails) {
    ...
    private fun getConfirmedData(orderDetails: BeverageHistoryDetails) {
        textViewEstimatedLabel.viewGone()
        textViewEstimatedMilesLabel.viewGone()
        isSelectedTrue(arrayListOf(textViewOrderPlaced, imageViewOrderPlaced, viewLineOne,
    ...
    private fun getPreparingData(orderDetails: BeverageHistoryDetails, isPickUpDate: Boolean) {
        textViewEstimatedLabel.viewShow()
        textViewEstimatedMilesLabel.viewGone()
        isSelectedTrue(arrayListOf(textViewOrderPlaced, imageViewOrderPlaced, viewLineOne, imageViewOrderConfirm, textViewOrderConfirm, viewLineTwo,
                    ...
                    locationManager.locationUpdateLiveData.observe(this, Observer<LatLng> { latLng ->
                        getDistance(latLng.latitude.toString(), latLng.longitude.toString(),
                            ...
                            if (orderDetails.preparationMinutes!! - diffMinutes(orderDetails.preparingTime) > 0) {
                                ...
                                textViewOrderProcess.text = getString(R.string.order_process, ((orderDetails.preparationMinutes - diffMinutes(orderDetails.preparingTime)).toInt()).toString())*/
                                ...
                                //textViewEstimatedLabel.text = getString(R.string.estimated_time, it)
                                textViewOrderProcess.text = getString(R.string.order_process, "0")
                            }
                        }
    ...
    private fun getOnTheWayData(orderDetails: BeverageHistoryDetails) {
        buttonTrack.viewShow()
        textViewEstimatedLabel.viewShow()
        //  textViewEstimatedMilesLabel.viewShow()
        ...
        getDistanceDuration(orderDetails.driverDetails.latitude!!, orderDetails.driverDetails.longitude!!,
            ...
            textViewEstimatedLabel.text = getString(R.string.estimated_time, duration)
            textViewEstimatedMilesLabel.text = getString(R.string.estimated_miles, round(distance.toFloat()).toString())
        }
    }

    private fun getDeliverData(orderDetails: BeverageHistoryDetails) {
